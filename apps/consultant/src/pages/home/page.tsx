            ...
            <>
              ...
              <styled.div display="flex" gap="2" flexWrap="wrap">
                ...
                <Button variant="outline" size="sm" asChild>
                  <Link
                    to={buildPath(`/bookings/${nextBooking.bookingId}/memo`)}
                  >
                    鑑定メモ編集
                  </Link>
                </Button>
        ...
        <styled.div rounded="l2" borderWidth="1px" borderColor="border" p="5">
          ...
          <styled.div display="flex" flexDir="column" gap="2">
            <Button variant="outline" justifyContent="flex-start" asChild>
              <Link to={buildPath("/bookings")}>予約一覧を開く</Link>
            </Button>
            <Button variant="outline" justifyContent="flex-start" asChild>
              <Link to={buildPath("/slots")}>予約枠を調整する</Link>
            </Button>
            <Button variant="outline" justifyContent="flex-start" asChild>
              <Link to={buildPath("/profile")}>プロフィールを更新する</Link>
            </Button>
          </styled.div>
        </styled.div>
      </styled.div>
            ...
            {todayBookings.map((booking) => (
              ...
              >
                ...
                >
                  ...
                  <Button variant="outline" size="sm" asChild>
                    <Link to={buildPath(`/bookings/${booking.bookingId}/memo`)}>
                      鑑定メモ編集
                    </Link>
                  </Button>
                </styled.div>
